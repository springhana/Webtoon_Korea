...
import styles from "../style/WebtoonComment.module.css";
import YesNo from "./modals/YesNo";
export default function WebtoonComment({ webtoonID }: any) {
  ...
  return (
    <div className={styles.webtoon_comment}>
      ...
      <div className={styles.webtoon_comment_outter}>
        ...
        {loading
          ? "Loading..."
          : commentAll.map((data: any, index: number) => (
                ...
                <div className={styles.webtoon_comment_post_container}>
                  ...
                  login.loginCheck._id === data.userId ? (
                    id === data._id && yesNo ? (
                      <form
                        method="POST"
                        action="https://port-0-webtoon-korea-server-30yyr422almfl7fw9.sel5.cloudtype.app/webtoon/update?_method=PUT"
